	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="2500">
	  ...
	  <div class="carousel-inner">
	    <div class="carousel-item active">
	      <img src="./img/cat_3.jpg" class="d-block w-100" alt="..." id="banner">
	    </div>
	    <div class="carousel-item">
	      <img src="./img/dog_2.jpg" class="d-block w-100" alt="..." id="banner">
	    </div>
	    <div class="carousel-item">
	      <img src="./img/dog_4.jpeg" class="d-block w-100" alt="..." id="banner">
	    </div>
	  </div>
