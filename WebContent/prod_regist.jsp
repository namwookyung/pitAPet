...
<html>
  <head>
	...
	<link rel="stylesheet" href="./css/prod_regist.css" />
	...
	<section>
		<form method="post" action="joinAction.jsp">
			...
			<div class="form-group">
				상품명<input type="text" class="form-control" name="pName" maxlength="20" required="required" />
			</div>
			<div class="form-group">
				가격<input type="text" class="form-control" name="pPrice" maxlength="20" required="required" />
			</div>
			<div class="form-group">
				상세 정보<textarea class="form-control" name="pMemo" rows="10" cols="20" wrap="off"></textarea>
			</div>
			<div class="form-group">
				상품 이미지<input type="file" class="form-control" style="border:none" name="pImage" maxlength="20" required="required" />
			</div>
			<div class="bts">
				<button type="submit" class="btn form-control" id="btn">등록하기</button>
				<button type="reset" class="btn form-control" id="btn">다시 작성</button>
				<button type="button" class="btn form-control" id="btn" onclick="location.href='prod_list.jsp'">목록 보기</button>
			</div>
		</form>
	</section>
